      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.html" class="text-nowrap logo-img">
            <img src="{{ asset("backend-asset/src") }}/assets/images/logos/logo.svg" alt="" />
          </a>
          ...
          <div class="unlimited-access hide-menu bg-light-secondary position-relative mb-7 mt-5 rounded">
            <div class="d-flex">
              ...
              <div class="unlimited-access-img">
                <img src="{{ asset("backend-asset/src") }}/assets/images/backgrounds/rocket.png" alt="" class="img-fluid">
              </div>
            </div>
          </div>
        </nav>
